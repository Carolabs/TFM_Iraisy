...
def cosimulate(individual):
    ...
    # Usar el error con la energía analítica
    return LA.norm(abs(energy - cosim_E), 2)
...
def check(individual):
    ...
    return cosim_t, cosim_fc, cosim_s1, cosim_s1d, cosim_s1dd, cosim_s2, cosim_s2d, cosim_s2dd, cosim_T, cosim_V, cosim_E, cosim_dP, cosim_dE, cosim_dEAcc, energy, cosim_Balance
