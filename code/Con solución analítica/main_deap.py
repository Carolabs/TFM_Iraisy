...
def ga(population, toolbox, stats, logbook, best, n_gen):
    ...
    _, _, _, _, _, _, _, _, _, _, cosim_E, _, _, _, energy, _ = check((mu, k, limit))
...
if __name__ == "__main__":
    ...
    _, _, _, _, _, _, _, _, _, _, cosim_E, _, _, _, energy, _ = check((p_mu, p_k, p_lim))
    print("Error en la solución:", numpy.linalg.norm(cosim_E - energy) / numpy.sqrt(10001), "J")
    print('=======================================================================================')
    print('')
    ...
    output.to_csv('Case6_quality_1_gen.csv', sep = ',', index = False, header = True)
