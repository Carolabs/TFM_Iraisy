% This file defines a class that represents the hydraulics actuation of a
% single-actuator 2-d.o.f crane.

% Input: 	displacement and velocity of hydraulic actuator
% Output: 	hydraulic force OR hydraulic pressures in the cylinder

classdef hydraulics < CosimUnit
    ...
    methods
        ...
        function b = hydraulics(name, outputIsF, kappaIsSinus)
            
            % Call constructor of base class
            b@CosimUnit(name);
            
            % Select output to be force or pressures
            assert( (outputIsF==1)||(outputIsF==0),...
                "Wrong value for outputIsF");
            b.yIsF = outputIsF;
            ...
            % Input profile
            b.SYS.inputK  = kappaIsSinus;            % 0: steps; 1: sin
        ...
        function y = readOutputs(b)
            ...
            elseif (b.yIsF == 0)
                % Return pressures
                % Pass also piston area and damping, necessary to evaluate
                % the hydraulic force
                b.Y_ = [b.p(1); b.p(2); b.SYS.A; b.SYS.c];
            end
		...
		% _____________________________________________ Set effective force
