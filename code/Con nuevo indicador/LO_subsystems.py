...
class mass_yF_uS(CosimUnit):
    ...
    def evaluateSpringForces(self):
        ...
        self.__fc_dp  = -(self.__cc * (self.__xd - self.__u[1]))

        # Spring and damper betweeen mass and wall
        self.__f_sp = - self.__k * self.__x
        self.__f_dp = - self.__c * self.__xd
    ...
    def doStep(self, finalT):
        ...
        # print('---------------------------')
        # print('Time:', self.__time, 'in SS: ', self.__name)
        # print(LHS)
        # print(RHS)
        # print(self.__x)
        # print(self.__xd)
...
# ________________________________________________________________________________________________YS_US
# This file defines a class that represent a mass-spring system that
# returns displacement and velocity as output.

#   |         |----|             
#   |--/\/\/--| m1 |----/\/\/---- -> x1, x1d
#   | k1, c1  |----|   k_c, c_c  

# Input: displacement and velocity of the other subsystem
# Output: displacement and velocity of this subsystem
# The coupling damping and stiffness are required by this subsystem; the
# coupling force is evaluated internally
class mass_yS_uS(CosimUnit):
